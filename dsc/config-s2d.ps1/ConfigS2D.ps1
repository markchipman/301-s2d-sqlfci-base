...
configuration ConfigS2D
{
    ...
    Node localhost
    {
        ...
        Script EnableS2D
        {
            SetScript = "Enable-ClusterS2D -Confirm:0 -Verbose; New-Volume -StoragePoolFriendlyName S2D* -FriendlyName Data_Vol0 -FileSystem NTFS -DriveLetter F -UseMaximumSize -ResiliencySettingName Mirror -Verbose"
